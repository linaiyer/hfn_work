...
class _play_video_intro_screen extends State<play_video_intro_screen> {
  ...
  setThubm() async {
    ...
    final byteData = await rootBundle.load("assets/videos/intronew.mp4");
    Directory tempDir = await getTemporaryDirectory();

    File tempVideo = File("${tempDir.path}/assets/videos/intronew.mp4")
  ...
  setData() async {
    ...
    dirPath = 'assets/videos/intronew.mp4';
