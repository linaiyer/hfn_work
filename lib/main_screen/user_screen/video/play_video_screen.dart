...
class _play_video_screen extends State<play_video_screen> {
  ...
  setThubm() async {
    ...
    final byteData = await rootBundle.load("assets/videos/relaxnew.mp4");
    Directory tempDir = await getTemporaryDirectory();

    File tempVideo = File("${tempDir.path}/assets/videos/relaxnew.mp4")
  ...
  setData() async {
    ...
    dirPath = 'assets/videos/relaxnew.mp4';
